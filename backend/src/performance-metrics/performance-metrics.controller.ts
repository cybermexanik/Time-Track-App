...
export class PerformanceMetricsController {
  ...
  create(@Body() createPerformanceMetricDto: CreatePerformanceMetricDto, @Req() req) {
    return this.performanceMetricsService.create(createPerformanceMetricDto, +req.user.id);
  }
